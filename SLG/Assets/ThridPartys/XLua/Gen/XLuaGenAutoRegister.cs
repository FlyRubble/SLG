...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>>), SystemCollectionsGenericDictionary_2_SystemStringSLGEventAction_1_SystemString__Wrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(SLG.UnityAsset.UnityAsyncAsset), SLGUnityAssetUnityAsyncAssetWrap.__Register);

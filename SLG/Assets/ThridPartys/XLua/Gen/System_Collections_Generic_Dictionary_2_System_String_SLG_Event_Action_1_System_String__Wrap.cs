...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericDictionary_2_SystemStringSLGEventAction_1_SystemString__Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>>);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>> gen_ret = new System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>> gen_ret = new System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>>(_capacity);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEqualityComparer<string>>(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>> gen_ret = new System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>>(_comparer);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<string>>(L, 3))
				{
					...
					System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>> gen_ret = new System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>>(_capacity, _comparer);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>> constructor!");
        ...
        static int _m_get_Item(RealStatePtr L)
        {
		    try {
                ...
                System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>> gen_to_be_invoked = (System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>>)translator.FastGetCSObj(L, 1);
        ...
        static int _m_set_Item(RealStatePtr L)
        {
		    try {
                ...
                
                {
					...
					string key = LuaAPI.lua_tostring(L, 2);
					SLG.Event.Action<string> gen_value = translator.GetDelegate<SLG.Event.Action<string>>(L, 3);
        ...
        static int _m_Add(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    SLG.Event.Action<string> _value = translator.GetDelegate<SLG.Event.Action<string>>(L, 3);
        ...
        static int _m_ContainsValue(RealStatePtr L)
        {
		    try {
                ...
                {
                    SLG.Event.Action<string> _value = translator.GetDelegate<SLG.Event.Action<string>>(L, 2);
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        System.Collections.Generic.Dictionary<string, SLG.Event.Action<string>>.Enumerator gen_ret = gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_TryGetValue(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _key = LuaAPI.lua_tostring(L, 2);
                    SLG.Event.Action<string> _value;

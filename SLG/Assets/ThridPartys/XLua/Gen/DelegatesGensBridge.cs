...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp15(float p0, float p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp16(SLG.UI.UIBase p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp17(bool p0, SLG.UnityAsset.UnityAsyncAsset p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(SLG.Event.Action))
			{
			    return new SLG.Event.Action(__Gen_Delegate_Imp0);
			}
		    ...
		    if (type == typeof(SLG.Event.Action<string>))
			{
			    return new SLG.Event.Action<string>(__Gen_Delegate_Imp2);
			}
		    ...
		    if (type == typeof(SLG.Event.Action<float>))
			{
			    return new SLG.Event.Action<float>(__Gen_Delegate_Imp14);
			}
		
		    if (type == typeof(SLG.Event.Action<float, float>))
			{
			    return new SLG.Event.Action<float, float>(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(SLG.Event.Action<SLG.UI.UIBase>))
			{
			    return new SLG.Event.Action<SLG.UI.UIBase>(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(SLG.Event.Action<bool, SLG.UnityAsset.UnityAsyncAsset>))
			{
			    return new SLG.Event.Action<bool, SLG.UnityAsset.UnityAsyncAsset>(__Gen_Delegate_Imp17);
			}
